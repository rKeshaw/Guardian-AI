...
from aegis.core.pipeline_contracts import (
...
from aegis.models.scan_session import ScanSession, ScanStatus
...
class CentralOrchestrator:
    ...
    async def _ensure_cleanup_running(self) -> None:
        if self._cleanup_task is None or self._cleanup_task.done():
            self._cleanup_task = asyncio.create_task(self._cleanup_loop(), name="aegis-session-cleanup")
