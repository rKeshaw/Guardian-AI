const state = {
  ...
  currentParams: {},
  sessions: JSON.parse(sessionStorage.getItem("guardian_sessions") || "[]"),
  apiKey: sessionStorage.getItem("guardian_api_key") || "",
  activeWebSockets: {},
  sessionPoller: null,
  healthPoller: null,
};
...
function submitApiKey() {
  ...
  sessionStorage.setItem("guardian_api_key", state.apiKey);
  hideApiKeyModal();
  initApp();
}
